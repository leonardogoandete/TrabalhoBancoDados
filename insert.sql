...
-- Montagens  --
INSERT INTO "USR271"."PC" (ID_MONTAGEM, ID_PLACAMAE, ID_CONTA, ID_CPU) VALUES (b_PC.nextval, 3000, 100002, 4000);
INSERT INTO "USR271"."PC" (ID_MONTAGEM, ID_PLACAMAE, ID_CONTA, ID_CPU) VALUES (b_PC.nextval, 3001, 100002, 4007);
INSERT INTO "USR271"."PC" (ID_MONTAGEM, ID_PLACAMAE, ID_CONTA, ID_CPU) VALUES (b_PC.nextval, 3002, 100003, 4004);
INSERT INTO "USR271"."PC" (ID_MONTAGEM, ID_PLACAMAE, ID_CONTA, ID_CPU) VALUES (b_PC.nextval, 3004, 100003, 4001);
INSERT INTO "USR271"."PC" (ID_MONTAGEM, ID_PLACAMAE, ID_CONTA, ID_CPU) VALUES (b_PC.nextval, 3004, 100000, 4001);
INSERT INTO "USR271"."PC" (ID_MONTAGEM, ID_PLACAMAE, ID_CONTA, ID_CPU) VALUES (b_PC.nextval, 3003, 100000, 4006);
INSERT INTO "USR271"."PC" (ID_MONTAGEM, ID_PLACAMAE, ID_CONTA, ID_CPU) VALUES (b_PC.nextval, 3004, 100001, 4002);
INSERT INTO "USR271"."PC" (ID_MONTAGEM, ID_PLACAMAE, ID_CONTA, ID_CPU) VALUES (b_PC.nextval, 3000, 100001, 4001);
-- Montagens sem GPU --
INSERT INTO "USR271"."PC" (ID_MONTAGEM, ID_PLACAMAE, ID_CONTA, ID_CPU) VALUES (b_PC.nextval, 3000, 100002, 4000);
INSERT INTO "USR271"."PC" (ID_MONTAGEM, ID_PLACAMAE, ID_CONTA, ID_CPU) VALUES (b_PC.nextval, 3000, 100003, 4001);
INSERT INTO "USR271"."PC" (ID_MONTAGEM, ID_PLACAMAE, ID_CONTA, ID_CPU) VALUES (b_PC.nextval, 3000, 100000, 4000);
INSERT INTO "USR271"."PC" (ID_MONTAGEM, ID_PLACAMAE, ID_CONTA, ID_CPU) VALUES (b_PC.nextval, 3000, 100001, 4000);
...
INSERT INTO "USR271"."PC_PLACAVIDEO" (ID_MONTAGEM) VALUES (2002);
...
INSERT INTO "USR271"."PC_PLACAVIDEO" (ID_MONTAGEM) VALUES (2005);
...
INSERT INTO "USR271"."PC_PLACAVIDEO" (ID_MONTAGEM) VALUES (2008);
...
INSERT INTO "USR271"."PC_PLACAVIDEO" (ID_MONTAGEM) VALUES (2011);
